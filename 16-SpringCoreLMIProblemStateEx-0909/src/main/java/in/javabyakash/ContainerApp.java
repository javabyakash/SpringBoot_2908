...
public class ContainerApp {
	public static void main(String[] args) {
		...
		System.out.println(ts1.hashCode()+" -=-=-=-=-=- "+tok1);
		
		//reading Token object to see object is created newly
